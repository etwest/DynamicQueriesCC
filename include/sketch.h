...
class Sketch {
 ...
 public:
  ...
  std::pair<vec_hash_t, std::vector<size_t>> get_bucket_ids(const vec_t update_idx);
  void update(const vec_t update_idx, vec_hash_t checksum, std::vector<size_t> bucket_ids);
